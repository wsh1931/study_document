...
![在这里插入图片描述](https://github.com/wsh1931/interview-experience/blob/master/images/f090b447b52a6880c81a662f2ec9b066.png)
...
![image-20250209185544837](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250209185544837.png)
...
![image-20250209185619083](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250209185619083.png)
...
![image-20250209213443431](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250209213443431.png)
...
![image-20250209183859631](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250209183859631.png)

![image-20250209183534528](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250209183534528.png)

##### 出现丢数据怎么解决：当主节点更新数据和还没来得及把数据同步到其他镜像节点

使用仲裁队列，主从模式，基于Raft协议实现强一致性数据同步，简化配置，提高数据安全性。

![image-20250209183604386](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250209183604386.png)
...
![image-20250210143522072](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210143522072.png)
...
![image-20250210210004478](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210210004478.png)
...
![image-20250210211051631](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210211051631.png)
...
![image-20250210213113323](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210213113323.png)

###### MarkWord

![image-20250210213144112](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210213144112.png)
...
![image-20250210213209057](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210213209057.png)
...
![image-20250210213304872](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210213304872.png)

2.通过CAS指令将Lock Record的地址存储在对象头的mark word中（数据进行交换），如果对象处于无锁状态则修改成功，代表该线程获得了轻量级锁。

![image-20250210213318029](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210213318029.png)

3.如果是当前线程已经持有该锁了，代表这是一次锁重入。设置Lock Record第一部分为null，起到了一个重入计数器的作用。

![image-20250210213331004](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210213331004.png)
...
![image-20250210213502452](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210213502452.png)

3.如果Lock Record的 Mark Word不为null，则利用CAS指令将对象头的mark word恢复成为无锁状态。如果失败则膨胀为重量级锁。

![image-20250210213516143](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210213516143.png)
...
![image-20250210213706274](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210213706274.png)

2.通过CAS指令将Lock Record的**线程id**存储在对象头的mark word中，同时也设置偏向锁的标识为101，如果对象处于无锁状态则修改成功，代表该线程获得了偏向锁。

![image-20250210213719062](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210213719062.png)

3.如果是当前线程已经持有该锁了，代表这是一次锁重入。设置Lock Record第一部分为null，起到了一个重入计数器的作用。与轻量级锁不同的时，这里不会再次进行cas操作，只是判断对象头中的线程id是否是自己，因为缺少了cas操作，性能相对轻量级锁更好一些

![image-20250210213739412](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210213739412.png)
...
![image-20250210220605433](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210220605433.png)
...
![image-20250210223030099](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210223030099.png)
...
![image-20250210223045066](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210223045066.png)

- 线程2操作：V：int a = 100，A：int a = 100，B：修改后的值：int a = 99(a--)
  - 线程2拿A的值与主内存V的值进行比较，判断是否相等(目前不相等，因为线程1已更新V的值99)
  - 不相等，则线程2更新失败

![image-20250210223059498](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210223059498.png)

- 自旋锁操作
  - 因为没有加锁，所以线程不会陷入阻塞，效率较高
  - 如果竞争激烈，重试频繁发生，效率会受影响

![image-20250210223114542](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210223114542.png)
...
![image-20250210223149497](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210223149497.png)
...
![image-20250210223159598](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210223159598.png)
...
![image-20250210225403860](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210225403860.png)
...
![image-20250210225421600](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210225421600.png)

屏障添加的示意图

![image-20250210225433341](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210225433341.png)
...
![image-20250210225522259](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210225522259.png)

屏障添加的示意图

![image-20250210225533950](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250210225533950.png)
...
![image-20250211145356115](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250211145356115.png)
...
![image-20250211145413518](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250211145413518.png)
...
![image-20250212115140387](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212115140387.png)
...
![image-20250212115208089](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212115208089.png)
...
![image-20250212115248399](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212115248399.png)

**工作流程**

![image-20250212115310793](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212115310793.png)
...
![image-20250212124919703](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212124919703.png)

第二：使用jstack查看线程运行的情况，下图是截图的关键信息

运行命令：`jstack -l 46032`

![image-20250212124950654](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212124950654.png)
...
![image-20250212153405952](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212153405952.png)
...
![image-20250212153436088](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212153436088.png)
...
![image-20250212153525108](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212153525108.png)
...
![image-20250212155033946](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212155033946.png)
...
![image-20250212155052896](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212155052896.png)
...
![image-20250212155116363](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212155116363.png)
...
![image-20250212155145084](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212155145084.png)
...
![image-20250212165728827](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212165728827.png)
...
![image-20250212165752436](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212165752436.png)
...
![image-20250212172106214](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212172106214.png)
...
![image-20250212172627138](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212172627138.png)
...
![image-20250212174442515](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212174442515.png)
...
![image-20250212174509651](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212174509651.png)
...
![image-20250212174535214](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212174535214.png)
...
![image-20250212174812937](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212174812937.png)
...
![image-20250212200759736](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212200759736.png)
...
![image-20250212202934577](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212202934577.png)
...
![image-20250212203404935](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212203404935.png)
...
![image-20250212211629078](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212211629078.png)
...
![image-20250212211704015](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212211704015.png)
...
![image-20250212211800763](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212211800763.png)

**get方法/remove方法**

![image-20250212211812504](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212211812504.png)
...
![image-20250212211849482](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212211849482.png)

- 弱引用：表示一个对象处于可能有用且非必须的状态。在GC线程扫描内存区域时，一旦发现弱引用，就会回收到弱引用相关联的对象。对于弱引用的回收，无关内存区域是否足够，一旦发现则会被回收

![image-20250212211901972](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212211901972.png)

每一个Thread维护一个ThreadLocalMap，在ThreadLocalMap中的Entry对象继承了WeakReference。其中key为使用弱引用的ThreadLocal实例，value为线程变量的副本

![image-20250212211916039](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212211916039.png)
...
![image-20250212214853513](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212214853513.png)

**JVM由哪些部分组成，运行流程是什么？**

![image-20250212214911414](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212214911414.png)
...
![image-20250212215840964](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212215840964.png)
...
![image-20250212223636785](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212223636785.png)
...
![image-20250212223718552](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212223718552.png)
...
![image-20250212224425667](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212224425667.png)

**栈内存溢出情况**

- 栈帧过多导致栈内存溢出，典型问题：递归调用

![image-20250212224502101](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250212224502101.png)
...
![image-20250213105749047](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250213105749047.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739415501423-2.png)

**运行时常量池**

常量池是 *.class 文件中的，当该类被加载，它的常量池信息就会放入运行时常量池，并把里面的符号地址变为真实地址

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739415501417-1.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739416885520-7.png)

下图是NIO传输数据的流程，在这个里面主要使用到了一个直接内存，不需要在堆中开辟空间进行数据的拷贝，jvm可以直接操作直接内存，从而使数据读写传输更快。

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739416885520-8.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739418678924-13.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739418678924-14.png)
...
![image-20250213115542884](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250213115542884.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739420552624-19.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739421803324-22.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739421803324-23.png)

- 通过类的全名，获取类的二进制数据流。
- 解析类的二进制数据流为方法区内的数据结构（Java类模型） 
- 创建java.lang.Class类的实例，表示该类型。作为方法区这个类的各种数据的访问入口

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739421803324-24.png)

2.验证

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739421803324-25.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739421803324-26.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739421803324-27.png)

4.解析

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739421803324-28.png)

**把类中的符号引用转换为直接引用**

比如：方法中调用了其他方法，方法名可以理解为符号引用，而直接引用就是使用指针直接指向方法。

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739421803325-29.png)

5.初始化

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739421803325-30.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739421803325-31.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739437033543-52.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739437033543-53.png)

```Java
 String demo = null;
```

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739437033543-54.png)

当对象间出现了循环引用的话，则引用计数法就会失效

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739437033544-55.png)

先执行右侧代码的前4行代码

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739437033544-56.png)

目前上方的引用关系和计数都是没问题的，但是，如果代码继续往下执行，如下图

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739437033544-57.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739437033544-58.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739437686423-73.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739437686423-74.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739437686423-75.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739438368660-82.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739438368660-83.png)

- 新创建的对象，都会先分配到eden区

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739438368660-84.png)

- 当伊甸园内存不足，标记伊甸园与 from（现阶段没有）的存活对象
- 将存活对象采用复制算法复制到 to 中，复制完毕后，伊甸园和 from 内存都得到释放

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739438368660-85.png)

- 经过一段时间后伊甸园的内存又出现不足，标记eden区域to区存活的对象，将存活的对象复制到from区

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739438368661-86.png)

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739438368661-87.png)

- 当幸存区对象熬过几次回收（最多15次），晋升到老年代（幸存区内存不足或大对象会导致提前晋升）

**MinorGC、 Mixed GC 、 FullGC的区别是什么**

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739438368661-88.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739439623548-103.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739439623548-104.png)

**CMS（并发）垃圾收集器**

CMS全称 Concurrent Mark Sweep，是一款并发的、使用标记-清除算法的垃圾回收器，该回收器是针对老年代垃圾回收的，是一款以获取最短回收停顿时间为目标的收集器，停顿时间短，用户体验就好。其最大特点是在进行垃圾回收时，应用仍然能正常运行。

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739439623548-105.png)

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739439623548-106.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441553914-115.png)

**Young Collection(年轻代垃圾回收)**

- 初始时，所有区域都处于空闲状态

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441553914-116.png)

- 创建了一些对象，挑出一些空闲区域作为伊甸园区存储这些对象

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441553914-117.png)

- 当伊甸园需要垃圾回收时，挑出一个空闲区域作为幸存区，用复制算法复制存活对象，需要暂停用户线程

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441553914-118.png)

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441553914-119.png)

- 随着时间流逝，伊甸园的内存又有不足
- 将伊甸园以及之前幸存区中的存活对象，采用复制算法，复制到新的幸存区，其中较老对象晋升至老年代

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441553914-120.png)

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441553914-121.png)

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441553914-122.png)

**Young Collection + Concurrent Mark (年轻代垃圾回收+并发标记)** 

当老年代占用内存超过阈值(默认是45%)后，触发并发标记，这时无需暂停用户线程

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441553914-123.png)

- 并发标记之后，会有重新标记阶段解决漏标问题，此时需要暂停用户线程。
- 这些都完成后就知道了老年代有哪些存活对象，随后进入混合收集阶段。此时不会对所有老年代区域进行回收，而是根据暂停时间目标优先回收价值高（存活对象少）的区域（这也是 Gabage First 名称的由来）。

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441553914-124.png)

**Mixed Collection (混合垃圾回收)** 

复制完成，内存得到释放。进入下一轮的新生代回收、并发标记、混合收集

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441553914-125.png)

其中H叫做巨型对象，如果对象非常大，会开辟一块连续的空间存储巨型对象

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441553914-126.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441762630-151.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441762630-152.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441762630-153.png)

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739441762630-154.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739451034417-179.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739453503226-182.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739453503227-183.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739453942986-188.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739453942986-189.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739454591231-194.png)

可以内存、线程、类等信息

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739454591231-195.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739454682142-200.png)

监控程序运行情况

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739454682142-201.png)

查看运行中的dump

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739454682142-202.png)

查看堆中的信息

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739454682142-203.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739455038991-212.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739455038991-213.png)

3、通过查看堆信息的情况，可以大概定位内存溢出是哪行代码出了问题

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739455038991-214.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739455508908-221.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739455508908-222.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739455508908-223.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739455508908-224.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739524107567-2.png)

使用jwt解决单点登录的流程如下：

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739524107541-1.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739524484194-7.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739524484194-8.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739525759454-13.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739525759455-15.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739526733291-51.png)

**ELK基本架构**

ELK即Elasticsearch、Logstash和Kibana三个开源软件的缩写

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739526733291-52.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739526942121-57.png)

也可以在logback配置文件中设置日志的目录和名字

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739526942121-58.png)
...
![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739527006048-63.png)

1. idea中启动远程debug

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739527006048-64.png)
...
- 线上诊断工具Arthas(阿尔萨斯)，项目上线之后监控、排查
  ...
  - 核心功能：
  - ![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739527188776-69.png)

![img](https://github.com/wsh1931/interview-experience/blob/master/images/1739527188776-70.png)
...
用户登录后信息都存在 Redis 里，所以可以根据Redis是否存在该用户信息来判断用户是否登录。首先用户登录后会将用户数据存入 Redis 并设置Redis过期时间，以后用户每发送一次请求都会更新这个过期时间。然后设置定时任务定期检查 Redis 是否过期。最后通过 WebSocket 发送给前端用户登录状态。若不在线、Redis 数据过期，用户主动退出登录之后，删除用户数据。
...
![image-20250218220711743](https://github.com/wsh1931/interview-experience/blob/master/images/image-20250218220711743.png)
